...
import asd.CusInfo.JTextFieldLimit;

import java.awt.*;
import java.awt.event.*;

public class payment extends JPanel implements ActionListener, KeyListener {
	...
	pnlC, // 카드 패널
	pnlA, pnlA1, pnlA2, pnlA3, pnlA4, pnlA5, pnlA6,// 계좌이체 패널
	...
	static JRadioButton phone, noPassbook, card, account, payco, // 폰, 무통장, 카드, 계좌이체, payco
	...
	paycoLbl, paycoLbl2, paycoLbl3, paycoLbl4,
	yetLabel; //payco 라벨
	...
	static JTextField noTf, noTf2, noTf3, // 무통장 텍스트필드
	acTf, // account 텍스트필드
	accTf, accTf2; // 계좌이체 텍스트필드
	
	String bank[] = { "카카오뱅크 3333-07-0152358 윤수영"}; // 은행목록
	...
	public payment() {
		...
		yetLabel = new JLabel("아직 이용할 수 없습니다.");
		...
		phoneLbl2 = new JLabel("<html>소액 결제의 경우 PG사 정책에 따라 결제 금액 제한이 있을 수 있습니다."
				+ "<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>"
				+ "<br><br><br><br><br><br>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp&nbsp&nbsp"
				+ "&nbsp&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&"
				+ "nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 지금은 이용할 수 없습니다.</html>");
		//pnlP.add(phoneLbl);
		pnlP.add(phoneLbl2);
		//pnlP.add(yetLabel);
		...
		nopYes.setSelected(true);
		ind.setSelected(true);
		
		noTf2.setDocument(new JTextFieldLimit(4));
		noTf3.setDocument(new JTextFieldLimit(4));
		...
		cardLbl2 = new JLabel("<html>소액 결제의 경우 PG사 정책에 따라 결제 금액 제한이 있을 수 있습니다."
				+ "<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>"
				+ "<br><br><br><br><br><br>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp&nbsp&nbsp"
				+ "&nbsp&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&"
				+ "nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 지금은 이용할 수 없습니다.</html>");
		...
		// 계좌이체 결제 패널
		pnlA = new JPanel();
		pnlA.setLayout(new GridLayout(6, 0));
		...
		JLabel yetLabel2 = new JLabel("지금은 이용할 수 없습니다.");
		pnlA5.add(accLbl7);
		pnlA5.add(PNCombo2);
		pnlA5.add(accLbl8);
		pnlA5.add(accTf);
		...
		PNCombo2.setEnabled(false);
		accTf.setEnabled(false);
		accTf2.setEnabled(false);

		
		noTf2.addKeyListener(this);
		noTf3.addKeyListener(this);
		
		payCheck.setSelected(false);
		payCheck.setEnabled(false);
		
		//accCheck2.setEnabled(false);
		...
		paycoLbl4 = new JLabel("<html>www.payco.com 에 회원가입 후, 최초 1회 카드 및 계좌 정보를 등록하셔야 사용 가능합니다."
				+ "<br><br><br><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nb"
				...
				+ "p&nbsp&nbsp지금은 이용할 수 없습니다.</html>");
	...
	public void keyTyped(KeyEvent e) {
		// TODO Auto-generated method stub
		if (e.getSource() == noTf2 || e.getSource() == noTf3) {
